      ...
      {open && (
        <div style={{ marginTop: 14, fontSize: 12.5, color: "var(--text2)", lineHeight: 1.65 }}>
          <p style={{ marginBottom: 12 }}>
            ...
            de conversão comercial, combinando porte, lacuna de produto, distância ao PTT e base de
            assinantes.
          </p>
          ...
          >
            <b style={{ color: "var(--text)" }}>Sinais usados:</b> porte (Receita Federal), produtos
            contratados (Celeti, Hub, CDN, Rami), distância haversine entre UF e PTT IX.br mais
            próximo, total de assinantes e validade do e-mail. As recomendações de abordagem no
            painel lateral derivam dessas mesmas regras.
          </div>
        </div>
      )}
    </div>
