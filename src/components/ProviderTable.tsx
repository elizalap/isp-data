    ...
    <div>
      <div style={{ overflowX: "auto" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead>
            <tr>
              {["Provedor", "UF", "Município", "Porte", "ERP", "ASN", "Produtos", "Score", ""].map(
                (h) => (
          ...
          <tbody>
            {shown.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ ...tdStyle, color: "var(--text2)", fontSize: 11 }}>
                    {p.porte || "—"}
                  </td>
                  <td style={tdStyle}>
                    {p.erp || <span style={{ color: "var(--text3)" }}>—</span>}
                  </td>
                  <td style={tdStyle}>
                    {p.asn ? `AS${p.asn}` : <span style={{ color: "var(--text3)" }}>—</span>}
                  </td>
                  <td style={tdStyle}>
            ...
            {shown.length === 0 && (
              <tr>
                ...
                >
                  Nenhum provedor encontrado com os filtros atuais.
                </td>
              </tr>
            )}
          </tbody>
      ...
      >
        <span>
          {total.toLocaleString("pt-BR")} provedores · página {safe + 1} de {pageCount}
        </span>
