...
export const PTTS: { name: string; lat: number; lon: number }[] = [
  ...
  { name: "IX.br RJ", lat: -22.9, lon: -43.17 },
  { name: "IX.br FOR", lat: -3.72, lon: -38.54 },
  { name: "IX.br POA", lat: -30.03, lon: -51.23 },
  { name: "IX.br BSB", lat: -15.77, lon: -47.93 },
  { name: "IX.br BEL", lat: -1.46, lon: -48.5 },
  { name: "IX.br MAN", lat: -3.1, lon: -60.02 },
  { name: "IX.br SAL", lat: -12.97, lon: -38.5 },
  ...
  { name: "IX.br CGB", lat: -15.6, lon: -56.1 },
  ...
  { name: "IX.br SLZ", lat: -2.53, lon: -44.3 },
